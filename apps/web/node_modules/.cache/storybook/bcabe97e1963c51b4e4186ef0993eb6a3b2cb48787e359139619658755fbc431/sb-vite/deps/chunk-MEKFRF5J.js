...
var require_scheduler_development = __commonJS({
  "../../node_modules/next/dist/compiled/scheduler/cjs/scheduler.development.js"(exports) {
    "use strict";
    (function() {
...
var require_scheduler = __commonJS({
  "../../node_modules/next/dist/compiled/scheduler/index.js"(exports, module) {
    "use strict";
    if (false) {
      module.exports = null;
    } else {
...
var require_react_dom_client_development = __commonJS({
  "../../node_modules/next/dist/compiled/react-dom/cjs/react-dom-client.development.js"(exports) {
    "use strict";
    (function() {
...
+ <Activity %s>`,
      ...
      function updateActivityComponent(current2, workInProgress2, renderLanes2) {
        ...
        if (null === current2) {
          if (isHydrating) {
            ...
            if (current2 = nextHydratableInstance) {
              if (renderLanes2 = canHydrateHydrationBoundary(
                current2,
                rootOrSingletonContext
              ), renderLanes2 = null !== renderLanes2 && renderLanes2.data === ACTIVITY_START_DATA ? renderLanes2 : null, null !== renderLanes2) {
                var activityState = {
                ...
                workInProgress2.memoizedState = activityState;
                activityState = createFiberFromDehydratedFragment(renderLanes2);
                activityState.return = workInProgress2;
                workInProgress2.child = activityState;
                hydrationParentFiber = workInProgress2;
                nextHydratableInstance = null;
              }
            } else renderLanes2 = null;
        ...
        if (null !== activityState) {
          ...
          if (didSuspend)
          ...
          else if (warnIfHydrating(), didReceiveUpdate || propagateParentContextChanges(
            current2,
            workInProgress2,
            renderLanes2,
            false
            ...
            if (null !== nextProps && (activityInstance = getBumpedLaneForHydration(
              nextProps,
              renderLanes2
            ), 0 !== activityInstance && activityInstance !== activityState.retryLane))
              throw activityState.retryLane = activityInstance, enqueueConcurrentRenderForLane(current2, activityInstance), scheduleUpdateOnFiber(nextProps, current2, activityInstance), SelectiveHydrationException;
            renderDidSuspendDelayIfPossible();
            ...
            current2 = activityState.treeContext, nextHydratableInstance = getNextHydratable(
      ...
      function updateSuspenseComponent(current2, workInProgress2, renderLanes2) {
        ...
        var JSCompiler_object_inline_stack_2533 = workInProgress2.pendingProps;
        shouldSuspendImpl(workInProgress2) && (workInProgress2.flags |= 128);
        var JSCompiler_object_inline_message_2531 = false;
        var didSuspend = 0 !== (workInProgress2.flags & 128);
        (JSCompiler_object_inline_digest_2532 = didSuspend) || (JSCompiler_object_inline_digest_2532 = null !== current2 && null === current2.memoizedState ? false : 0 !== (suspenseStackCursor.current & ForceSuspenseFallback));
        JSCompiler_object_inline_digest_2532 && (JSCompiler_object_inline_message_2531 = true, workInProgress2.flags &= -129);
        JSCompiler_object_inline_digest_2532 = 0 !== (workInProgress2.flags & 32);
        workInProgress2.flags &= -33;
        if (null === current2) {
          if (isHydrating) {
            JSCompiler_object_inline_message_2531 ? pushPrimaryTreeSuspenseHandler(workInProgress2) : reuseSuspenseHandlerOnStack(workInProgress2);
            (current2 = nextHydratableInstance) ? (renderLanes2 = canHydrateHydrationBoundary(
              current2,
              rootOrSingletonContext
            ), renderLanes2 = null !== renderLanes2 && renderLanes2.data !== ACTIVITY_START_DATA ? renderLanes2 : null, null !== renderLanes2 && (JSCompiler_object_inline_digest_2532 = {
              dehydrated: renderLanes2,
              treeContext: getSuspendedTreeContext(),
              retryLane: 536870912,
              hydrationErrors: null
            }, workInProgress2.memoizedState = JSCompiler_object_inline_digest_2532, JSCompiler_object_inline_digest_2532 = createFiberFromDehydratedFragment(renderLanes2), JSCompiler_object_inline_digest_2532.return = workInProgress2, workInProgress2.child = JSCompiler_object_inline_digest_2532, hydrationParentFiber = workInProgress2, nextHydratableInstance = null)) : renderLanes2 = null;
            if (null === renderLanes2)
              throw warnNonHydratedInstance(workInProgress2, current2), throwOnHydrationMismatch(workInProgress2);
          ...
          if (JSCompiler_object_inline_message_2531) {
            ...
            JSCompiler_object_inline_stack_2533.return = workInProgress2;
            nextPrimaryChildren.sibling = JSCompiler_object_inline_stack_2533;
            workInProgress2.child = nextPrimaryChildren;
            JSCompiler_object_inline_stack_2533 = workInProgress2.child;
            JSCompiler_object_inline_stack_2533.memoizedState = mountSuspenseOffscreenState(renderLanes2);
            JSCompiler_object_inline_stack_2533.childLanes = getRemainingWorkInPrimaryTree(
              current2,
          ...
          if (null !== JSCompiler_object_inline_componentStack_2534) {
            if (didSuspend)
              workInProgress2.flags & 256 ? (pushPrimaryTreeSuspenseHandler(workInProgress2), workInProgress2.flags &= -257, workInProgress2 = retrySuspenseComponentWithoutHydrating(
                ...
                workInProgress2,
                renderLanes2
              )) : null !== workInProgress2.memoizedState ? (reuseSuspenseHandlerOnStack(workInProgress2), workInProgress2.child = current2.child, workInProgress2.flags |= 128, workInProgress2 = null) : (reuseSuspenseHandlerOnStack(workInProgress2), nextPrimaryChildren = JSCompiler_object_inline_stack_2533.fallback, mode = workInProgress2.mode, JSCompiler_object_inline_stack_2533 = mountWorkInProgressOffscreenFiber(
                {
                  mode: "visible",
                ...
                renderLanes2,
                null
              ), nextPrimaryChildren.flags |= 2, JSCompiler_object_inline_stack_2533.return = workInProgress2, nextPrimaryChildren.return = workInProgress2, JSCompiler_object_inline_stack_2533.sibling = nextPrimaryChildren, workInProgress2.child = JSCompiler_object_inline_stack_2533, reconcileChildFibers(
                workInProgress2,
                current2.child,
                null,
                renderLanes2
              ), JSCompiler_object_inline_stack_2533 = workInProgress2.child, JSCompiler_object_inline_stack_2533.memoizedState = mountSuspenseOffscreenState(renderLanes2), JSCompiler_object_inline_stack_2533.childLanes = getRemainingWorkInPrimaryTree(
                current2,
                JSCompiler_object_inline_digest_2532,
                renderLanes2
            ...
            else if (pushPrimaryTreeSuspenseHandler(workInProgress2), warnIfHydrating(), isSuspenseInstanceFallback(
              ...
              "string" === typeof JSCompiler_object_inline_digest_2532 && CapturedStacks.set(
                nextPrimaryChildren,
                JSCompiler_object_inline_stack_2533
              );
              ...
              renderLanes2,
              false
            ), JSCompiler_object_inline_digest_2532 = 0 !== (renderLanes2 & current2.childLanes), didReceiveUpdate || JSCompiler_object_inline_digest_2532) {
              JSCompiler_object_inline_digest_2532 = workInProgressRoot;
              if (null !== JSCompiler_object_inline_digest_2532 && (JSCompiler_object_inline_stack_2533 = getBumpedLaneForHydration(
                JSCompiler_object_inline_digest_2532,
                renderLanes2
              ), 0 !== JSCompiler_object_inline_stack_2533 && JSCompiler_object_inline_stack_2533 !== prevState.retryLane))
                throw prevState.retryLane = JSCompiler_object_inline_stack_2533, enqueueConcurrentRenderForLane(
                  current2,
                  JSCompiler_object_inline_stack_2533
        ...
        if (JSCompiler_object_inline_message_2531)
          return reuseSuspenseHandlerOnStack(workInProgress2), nextPrimaryChildren = JSCompiler_object_inline_stack_2533.fallback, mode = workInProgress2.mode, componentStack = current2.child, JSCompiler_object_inline_componentStack_2534 = componentStack.sibling, JSCompiler_object_inline_stack_2533 = createWorkInProgress(
            componentStack,
            {
              mode: "hidden",
              children: JSCompiler_object_inline_stack_2533.children
            }
          ), JSCompiler_object_inline_stack_2533.subtreeFlags = componentStack.subtreeFlags & 65011712, null !== JSCompiler_object_inline_componentStack_2534 ? nextPrimaryChildren = createWorkInProgress(
            JSCompiler_object_inline_componentStack_2534,
            nextPrimaryChildren
          ) : (nextPrimaryChildren = createFiberFromFragment(
            nextPrimaryChildren,
            ...
            renderLanes2,
            null
          ), nextPrimaryChildren.flags |= 2), nextPrimaryChildren.return = workInProgress2, JSCompiler_object_inline_stack_2533.return = workInProgress2, JSCompiler_object_inline_stack_2533.sibling = nextPrimaryChildren, workInProgress2.child = JSCompiler_object_inline_stack_2533, bailoutOffscreenComponent(null, JSCompiler_object_inline_stack_2533), JSCompiler_object_inline_stack_2533 = workInProgress2.child, nextPrimaryChildren = current2.child.memoizedState, null === nextPrimaryChildren ? nextPrimaryChildren = mountSuspenseOffscreenState(renderLanes2) : (mode = nextPrimaryChildren.cachePool, null !== mode ? (componentStack = CacheContext._currentValue, mode = mode.parent !== componentStack ? { parent: componentStack, pool: componentStack } : mode) : mode = getSuspendedCache(), nextPrimaryChildren = {
            baseLanes: nextPrimaryChildren.baseLanes | renderLanes2,
            cachePool: mode
          }), JSCompiler_object_inline_stack_2533.memoizedState = nextPrimaryChildren, JSCompiler_object_inline_stack_2533.childLanes = getRemainingWorkInPrimaryTree(
            current2,
            JSCompiler_object_inline_digest_2532,
            renderLanes2
        ...
        null !== current2 && (JSCompiler_object_inline_digest_2532 = workInProgress2.deletions, null === JSCompiler_object_inline_digest_2532 ? (workInProgress2.deletions = [current2], workInProgress2.flags |= 16) : JSCompiler_object_inline_digest_2532.push(current2));
      ...
      function commitMutationEffectsOnFiber(finishedWork, root2) {
        var prevEffectStart = pushComponentEffectStart(), current2 = finishedWork.alternate, flags = finishedWork.flags;
        switch (finishedWork.tag) {
          case 0:
          case 11:
          case 14:
              ...
              a: for (root2 = finishedWork.stateNode, root2._visibility = hoistableRoot ? root2._visibility & ~OffscreenVisible : root2._visibility | OffscreenVisible, hoistableRoot && (null === current2 || wasHidden || offscreenSubtreeIsHidden || offscreenSubtreeWasHidden || recursivelyTraverseDisappearLayoutEffects(finishedWork)), current2 = null, root2 = finishedWork; ; ) {
                if (5 === root2.tag || 26 === root2.tag) {
                  if (null === current2) {
                    ...
                    try {
                      currentResource = wasHidden.stateNode, hoistableRoot ? runWithFiberInDEV(
                        wasHidden,
                        hideInstance,
                        currentResource
                      ) : runWithFiberInDEV(
                  ...
                  if (null === current2) {
                    wasHidden = root2;
                    try {
                      maybeNodes = wasHidden.stateNode, hoistableRoot ? runWithFiberInDEV(
                        wasHidden,
                        hideTextInstance,
                        maybeNodes
                      ) : runWithFiberInDEV(
                  ...
                  if (null === current2) {
                    wasHidden = root2;
                    try {
                      i = wasHidden.stateNode, hoistableRoot ? runWithFiberInDEV(
                        wasHidden,
      ...
      function commitPassiveMountOnFiber(finishedRoot, finishedWork, committedLanes, committedTransitions) {
        ...
        switch (finishedWork.tag) {
          ...
          case 22:
            ...
            null !== finishedWork.memoizedState ? prevProfilerEffectDuration._visibility & OffscreenPassiveEffectsConnected ? recursivelyTraversePassiveMountEffects(
              finishedRoot,
              finishedWork,
              committedLanes,
              committedTransitions
              ...
              finishedRoot,
              finishedWork
            ) : prevProfilerEffectDuration._visibility & OffscreenPassiveEffectsConnected ? recursivelyTraversePassiveMountEffects(
              finishedRoot,
              finishedWork,
              committedLanes,
              committedTransitions
            ) : (prevProfilerEffectDuration._visibility |= OffscreenPassiveEffectsConnected, recursivelyTraverseReconnectPassiveEffects(
              finishedRoot,
              finishedWork,
              committedLanes,
              committedTransitions,
      ...
      function commitPassiveUnmountEffectsInsideOfDeletedTree_begin(deletedSubtreeRoot, nearestMountedAncestor$jscomp$0) {
        for (; null !== nextEffect; ) {
          var fiber = nextEffect, current2 = fiber, nearestMountedAncestor = nearestMountedAncestor$jscomp$0, prevEffectStart = pushComponentEffectStart();
          switch (current2.tag) {
            case 0:
            case 11:
            case 15:
          ...
          if (null !== prevEffectStart)
            ...
            a: for (fiber = deletedSubtreeRoot; null !== nextEffect; ) {
              ...
              current2 = prevEffectStart.sibling;
              ...
              if (null !== current2) {
                current2.return = nearestMountedAncestor;
                nextEffect = current2;
                break a;
              }
      ...
      function flushLayoutEffects() {
        if (pendingEffectsStatus === PENDING_LAYOUT_PHASE) {
          ...
          if (0 !== (finishedWork.subtreeFlags & 8772) || rootHasLayoutEffect) {
            ...
            executionContext |= CommitContext;
            try {
              null !== injectedProfilingHooks && "function" === typeof injectedProfilingHooks.markLayoutEffectsStarted && injectedProfilingHooks.markLayoutEffectsStarted(lanes), inProgressLanes = lanes, inProgressRoot = root2, componentEffectStartTime = -1.1, commitLayoutEffectOnFiber(
                root2,
                finishedWork.alternate,
                finishedWork
      ...
      }, now = Scheduler.unstable_now, renderStartTime = -0, commitStartTime = -0, profilerStartTime = -1.1, profilerEffectDuration = -0, componentEffectStartTime = -1.1, currentUpdateIsNested = false, nestedUpdateScheduled = false, currentEntangledListeners = null, currentEntangledPendingCount = 0, currentEntangledLane = 0, currentEntangledActionThenable = null, prevOnStartTransitionFinish = ReactSharedInternals.S;
...
var require_client = __commonJS({
  "../../node_modules/next/dist/compiled/react-dom/client.js"(exports, module) {
    if (false) {
      checkDCE();
      module.exports = null;
    } else {
...
next/dist/compiled/scheduler/cjs/scheduler.development.js:
  (**
   * @license React
...
next/dist/compiled/react-dom/cjs/react-dom-client.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MEKFRF5J.js.map
